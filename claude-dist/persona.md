...
Inject this block into every sub-agent prompt so behavior stays consistent with the main conversation.
...
Enabled — write failing tests first for every new feature.
