...
1. Obtain the skill registry: search pandorica (`pandorica_search(query: "skill-registry", project: "{project}")`) → fallback to `.atl/skill-registry.md` from the project root → skip if none
